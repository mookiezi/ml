...
def parse_args():
    ...
    parser.add_argument("-vb", "--val_batch_size", type=int, default=16, help="validation batch size")
...
def main():
    ...
    if args.input_method == 1:
        ...
        !cp "{save_path}.zip" "/content/drive/MyDrive/"
        print(f"\nCheckpoint saved and zipped at {save_path}.zip")
